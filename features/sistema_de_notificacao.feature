Feature: Sistema de Notificação
  ...
  So that eu posso fazer a licitação de despacho de lixo.
    ...
    Scenario: O peso da quantidade de resíduos já cadastrados no sistema é maior ou igual ao valor mínimo para fazer a licitação
        Given o sistema possui o departamento "Departamento de Fisica"
        And o sistema possui o laboratório "Laboratorio de Fisica1"
        And o sistema possui o resíduo "Cloreto de Potassio" cadastrado no laboratorio "Laboratorio de Fisica1"
    ...
    Scenario: O peso da quantidade de resíduos já cadastrados no sistema é maior ou igual que o limite mínimo para emitir um alerta
         Given o sistema possui o departamento "Departamento de Quimica"
        And o sistema possui o laboratório "Laboratorio de Quimica1"
        And o sistema possui o resíduo "Acido Cloridrico" cadastrado no laboratorio "Laboratorio de Quimica1"
